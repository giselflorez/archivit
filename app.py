...
try:
    import markdown
    HAS_MARKDOWN = True
    print("Markdown imported successfully", file=sys.stderr)
except ImportError as e:
    HAS_MARKDOWN = False
    print(f"Markdown import failed: {e}", file=sys.stderr)
...
print(f"Template dir exists: {os.path.exists(TEMPLATE_DIR)}", file=sys.stderr)
print(f"Docs dir exists: {os.path.exists(DOCS_DIR)}", file=sys.stderr)
